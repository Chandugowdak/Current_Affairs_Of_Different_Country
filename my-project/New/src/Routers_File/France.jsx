...
const France = () => {
  ...
  useEffect(() => {
    // FETCH NEWS DATA FROM NEWSAPI FOR FRANCE (COUNTRY CODE 'gb' IS FOR GREAT BRITAIN, NOT FRANCE)
    fetch('https://newsapi.org/v2/top-headlines?country=gb&apiKey=205125fcc7414b038a14b45538669b52')
