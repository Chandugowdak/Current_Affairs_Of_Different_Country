...
const United_States = () => {
  ...
  useEffect(() => {
    // FETCH NEWS DATA FROM NEWSAPI FOR UNITED STATES (COUNTRY CODE 'us' IS FOR UNITED STATES)
    fetch('https://newsapi.org/v2/top-headlines?country=us&apiKey=205125fcc7414b038a14b45538669b52')
