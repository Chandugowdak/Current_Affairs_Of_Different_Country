...
const Indian = () => {
  ...
  useEffect(() => {
    // FETCH NEWS DATA FROM NEWSAPI FOR INDIA (COUNTRY CODE 'in' IS FOR INDIA)
    fetch('https://newsapi.org/v2/top-headlines?country=in&apiKey=205125fcc7414b038a14b45538669b52')
