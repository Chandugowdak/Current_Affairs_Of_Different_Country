...
const HongKong = () => {
  ...
  useEffect(() => {
    // FETCH NEWS DATA FROM NEWSAPI FOR HONG KONG (COUNTRY CODE 'gb' IS FOR GREAT BRITAIN, CORRECT IT TO 'hk' FOR HONG KONG)
    fetch('https://newsapi.org/v2/top-headlines?country=hk&apiKey=205125fcc7414b038a14b45538669b52')
