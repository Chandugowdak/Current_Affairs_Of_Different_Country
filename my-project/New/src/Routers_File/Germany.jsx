...
const Germany = () => {
  ...
  useEffect(() => {
    // FETCH NEWS DATA FROM NEWSAPI FOR GERMANY (COUNTRY CODE 'ru' IS FOR RUSSIA, CORRECT IT TO 'de' FOR GERMANY)
    fetch('https://newsapi.org/v2/top-headlines?country=de&apiKey=205125fcc7414b038a14b45538669b52')
