...
const Netherlands = () => {
  ...
  useEffect(() => {
    // FETCH NEWS DATA FROM NEWSAPI FOR NETHERLANDS (COUNTRY CODE 'nl' IS FOR NETHERLANDS)
    fetch('https://newsapi.org/v2/top-headlines?country=nl&apiKey=205125fcc7414b038a14b45538669b52')
